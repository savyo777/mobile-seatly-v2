  ...
  render() {
    ...
    return (
      <View style={styles.root}>
        ...
        <Text style={styles.body}>The app recovered. Try again or return home.</Text>
        <View style={styles.actions}>
          <Pressable accessibilityRole="button" style={styles.secondaryButton} onPress={this.reset}>
            <Text style={styles.secondaryText}>Try again</Text>
          </Pressable>
          <Pressable accessibilityRole="button" style={styles.primaryButton} onPress={this.goHome}>
