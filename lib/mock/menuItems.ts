...
export const mockMenuItems: MenuItem[] = [
  ...
  { id: 'm8b', restaurantId: 'r1', name: 'Beet Carpaccio', description: 'Thinly sliced roasted beets with whipped ricotta and pistachios', price: 18.99, category: 'Appetizers', photoUrl: '', allergens: ['dairy'], dietaryFlags: ['vegetarian', 'gluten-free'], isAvailable: false, isPreorderable: false, isFeatured: false, preparationTimeMinutes: 10, calories: 220 },
  // Sakura Sushi
