...
function makeDemoExpense(partial: Partial<Expense> & { id: string; vendorName: string; expenseDate: string; totalAmount: number; category: Expense['category'] }): Expense {
  return {
    restaurantId: 'r1',
    createdBy: 'u1',
...
export const DEMO_EXPENSES: Expense[] = [
  ...
  makeDemoExpense({
    id: 'demo-exp-3',
    vendorName: 'Pacific Wine & Spirits',
