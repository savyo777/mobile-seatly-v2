...
export const CENAIVA_QA_SCENARIOS: CenaivaQaScenario[] = [
  ...
  ...[
    ...
    ['restaurant-search-closest-single', "What's the closest restaurant to me?"],
    ['restaurant-search-other-options-follow-up', 'What other restaurants are there?'],
    ['restaurant-search-european-nearby', 'Show me European restaurants nearby.'],
