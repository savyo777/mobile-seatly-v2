// Cenaiva Restaurant Partner Agreement — verbatim port of the web source of truth
...
// Version 2.2. Do NOT hand-edit wording without re-porting from web.
...
export const PARTNER_AGREEMENT_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    "paragraphs": [
      "New restaurant partners receive a complimentary Trial Period of ninety (90) days. The Trial Period begins on the day you publish your restaurant (make it live to Diners), not when you register or save a card. During the Trial Period the monthly Subscription Fee is waived.",
  ...
  {
    "heading": "5.2. Billing, Payment, and Tax Treatment",
    "paragraphs": [
  ...
  {
    "heading": "5.3. Late Payment",
    "paragraphs": [
      "If a payment fails, Stripe automatically retries the charge on its standard schedule and we will notify you by email. Your access to the Platform continues while these retries are pending.",
  ...
  {
    "heading": "5.5. No Pause Option",
    "paragraphs": [
      "Subscriptions are either active or scheduled for cancelation at the end of the current Billing Cycle. There is no option to pause a subscription. If you cancel, your access will continue until the end of the current paid Billing Cycle, after which it will be deactivated."
    ]
  },
  {
    "heading": "5.6. Cancellation and Refunds",
    "paragraphs": [
      "• You may cancel your subscription at any time by contacting help@cenaiva.com or by removing your restaurant from the Partner Dashboard.",
  ...
  {
    "heading": "5.7. Deposits, Refunds, Chargebacks, and Payment Disputes",
    "paragraphs": [
  ...
  {
    "heading": "10.1. Data Controller Structure",
    "paragraphs": [
  ...
  {
    "heading": "10.2. Your Privacy Obligations",
    "paragraphs": [
  ...
  {
    "heading": "10.3. Booking Data Shared by Cenaiva",
    "paragraphs": [
  ...
  {
    "heading": "10.4. Staff Accounts, Biometric Authentication, and Sensitive Actions",
    "paragraphs": [
  ...
  {
    "heading": "10.7. Cenaiva Personnel Access",
    "paragraphs": [
  ...
  {
    "heading": "10.9. Breach Notification",
    "paragraphs": [
  ...
  {
    "heading": "10.10. AI and Aggregated Data",
    "paragraphs": [
  ...
  {
    "heading": "10.11. Data Subject Requests",
    "paragraphs": [
  ...
  {
    "heading": "11.1. Cenaiva's Property",
    "paragraphs": [
  ...
  {
    "heading": "11.3. Use of Restaurant Name and Marks",
    "paragraphs": [
  ...
  {
    "heading": "11.5. Cenaiva IP Indemnity",
    "paragraphs": [
  ...
  {
    "heading": "11.6. Content Moderation",
    "paragraphs": [
  ...
  {
    "heading": "14.1. Termination by You",
    "paragraphs": [
  ...
  {
    "heading": "14.2. Termination by Cenaiva — Minor Violations",
    "paragraphs": [
  ...
  {
    "heading": "14.3. Termination by Cenaiva — Serious Violations",
    "paragraphs": [
  ...
  {
    "heading": "14.5. Effect of Termination",
    "paragraphs": [
      "Upon termination:",
  ...
  {
    "heading": "14.7. Termination by Cenaiva — Without Cause",
    "paragraphs": [
  ...
  {
    "heading": "18.1. Service Availability",
    "paragraphs": [
...
export const PARTNER_AGREEMENT_HISTORY: AgreementHistoryEntry[] = [
  {
    ...
    "summary": "Corrected the Diner-payment fee model to a 2% platform fee on the food amount that is paid by the Diner at checkout (the restaurant receives 100% of food and applicable tax); corrected the merchant-of-record and payouts terms to reflect Stripe Connect, under which Diner payments are routed to the restaurant's connected account as a destination transfer; removed the unenforced 500-restaurant Trial cap and anchored the 90-day Trial to publication; and corrected the late-payment, cancellation and deletion timing, refund, and referral terms to match the deployed Platform."
  },
  {
    "version": "2.1",
    "effectiveDate": "May 21, 2026",
    "summary": "Initial published version of the v2.x agreement family. Establishes Subscription Fee at CAD $199.99/month, Per-Booking Platform Fee at CAD $1.00, Pre-Order Fee at 5.5%, the three-month Trial Period (first 500 qualifying restaurant partners), data-processing addendum (§10), and Schedule A sub-processor list."
  }
];
