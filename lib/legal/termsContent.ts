// Cenaiva Terms of Service — verbatim port of the web source of truth
...
// Version 2026-05-30. Do NOT hand-edit wording without re-porting from web.

import type { LegalSection } from './types';
import { TERMS_VERSION, TERMS_EFFECTIVE_DATE, TERMS_LAST_UPDATED } from './versions';
...
export const TERMS_SECTIONS: LegalSection[] = [
  ...
  {
    "heading": "4.2. Reservation Holds (Cart System)",
    "paragraphs": [
      "To secure your preferred time slot during the booking process, Cenaiva temporarily reserves (\"holds\") your selected slot for a limited period while you complete your booking details and any required payment. During this hold period:",
  ...
  {
    "heading": "4.3. Availability Alerts",
    "paragraphs": [
  ...
  {
    "heading": "4.4. Group Deposit Invitations",
    "paragraphs": [
      "For certain bookings requiring a deposit, and where this feature is available, a booking party may split the deposit across more than one payment card. When this option is offered:",
  ...
  {
    "heading": "6.2. AI Accuracy, Hallucinations, and Limitations",
    "paragraphs": [
      "Cenaiva AI can and does make mistakes. AI systems — including ours — can produce incorrect, incomplete, or entirely fabricated outputs, commonly referred to as \"hallucinations.\" You acknowledge and agree that:",
  ...
  {
    "heading": "6.3. AI Quality Monitoring",
    "paragraphs": [
      "Cenaiva monitors the quality of AI responses to improve the platform. A sample of AI conversations may be scored and reviewed by automated systems or Cenaiva staff for accuracy, safety, and compliance with our policies. This review is used solely for service improvement and is governed by our Privacy Policy."
    ]
  },
  {
    "heading": "6.4. AI Auto-Tagging and Guest Profiling",
    "paragraphs": [
      "Cenaiva uses automated systems to analyse your booking history, preferences, and behaviour to generate guest tags and a lifetime-value estimate. Tags are shared with a restaurant when you book or visit their venue and are used to personalize your experience. Lifetime-value and no-show-risk signals are computed and may be made available to restaurant partners as these features roll out. Tags reflect general behavioural categories only (for example, \"frequent diner\") and do not include sensitive personal characteristics. You may contact us at privacy@cenaiva.com to request a review or correction of automated profiling associated with your account."
    ]
  },
  {
    "heading": "6.5. Voice Data Deletion",
    "paragraphs": [
      "You may request deletion of your stored voice recordings and transcripts at any time by contacting us at privacy@cenaiva.com. Requests will be processed within 30 days. Deletion of voice data does not delete your account or booking history."
    ]
  },
  {
    "heading": "7.1. Post-Visit Photo Prompts",
    "paragraphs": [
      "After a completed dining session, Cenaiva may send you a notification — push on the mobile app, and in-app on the website — inviting you to share a review, and where available a photo, from your visit. These prompts are optional and can be disabled in your notification settings."
    ]
  },
  {
    "heading": "7.2. Visit Photos and Story Filters",
    "paragraphs": [
      "Where this feature is available, Cenaiva may allow you to upload photos from your dining visits, optionally enhanced with in-app story filters. By uploading a visit photo:",
  ...
  {
    "heading": "7.3. Restaurant Reviews",
    "paragraphs": [
  ...
  },
  {
    "heading": "7.4. Surveys",
    "paragraphs": [
      "Cenaiva may invite you to complete optional in-app surveys about your dining experience. Survey responses are used for service improvement. Participation is entirely voluntary."
    ]
  },
  {
    "heading": "8.1. Social Posts and Snaps",
    "paragraphs": [
      "Where this feature is available, Cenaiva may allow you to create and share social content (\"Snaps\") including photos, captions, and dining moments. When you submit a Snap:",
  ...
  {
    "heading": "11.2. Payment Processing and Saved Cards",
    "paragraphs": [
  ...
  {
    "heading": "11.6. Chargebacks",
    "paragraphs": [
      "In the event of a disputed charge, please contact us at help@cenaiva.com before initiating a chargeback. Chargebacks initiated in bad faith, without prior contact, may result in account suspension."
    ]
  },
  {
