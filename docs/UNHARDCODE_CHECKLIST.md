...
- [ ] **`app/(customer)/profile/register-restaurant-card-entry.tsx`** — `MONTHLY_FEE_LABEL = '$89.00 / mo'` is inlined for the receipt totals. Move to a single owner-pricing source once Cenaiva monthly pricing exists in config.
