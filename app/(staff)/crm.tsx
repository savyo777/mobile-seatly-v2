...
const styles = StyleSheet.create({
  ...
  aiStripHint: { fontSize: 10, fontWeight: '800', color: ownerColors.gold, letterSpacing: 1, textTransform: 'uppercase' },
  ...
  tagPillText: { fontSize: 10, fontWeight: '800', color: ownerColors.textSecondary, textTransform: 'uppercase' },
  ...
  bonusLabel: { fontSize: 10, fontWeight: '700', color: ownerColors.textMuted, textTransform: 'uppercase', letterSpacing: 0.4 },
  ...
  dmLabel: { fontSize: 10, fontWeight: '700', color: ownerColors.textMuted, textTransform: 'uppercase', marginBottom: 4 },
