...
export default function BookingDetailScreen() {
  ...
  const handleCancel = useCallback(() => {
    ...
    //   2. The Cenaiva platform fee (2%) + Stripe processing fee
    ...
    const refundLine = depositCharged
      ? '\n\nIf the deposit was charged, the deposit base will be refunded to your original card and appear on your statement within 5 business days. The Cenaiva platform fee (2%) and Stripe processing fee you paid at booking are non-refundable (this was disclosed at checkout).'
      : '';
    Alert.alert(
