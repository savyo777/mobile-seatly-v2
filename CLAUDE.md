...
| Owner referral policy (code format, +30 days bonus per side, deep-link) | `lib/owner/referralPolicy.ts` (mirrored server-side in `supabase/functions/_shared/referral-policy.ts`) |
